    ...
    public class BlogServiceImpl implements BlogService {
        ...
        public Page<BlogSummaryDTO> getBlogsByUser(Integer userId, Pageable pageable) {
            ...
            Page<Blog> blogs = blogRepository.findByUserIdAndOptionalStatus(
                    userId,
                    isAdmin ? null : BlogApprovalStatus.APPROVED,
                    pageable
            );
        ...
        @Transactional(readOnly = true)
        public Page<BlogSummaryDTO> searchBlogsByPartialTitle(String title, Integer userId, Pageable pageable) {
            Integer currentUserId = jwtUtils.getUserIdFromContext();
            Page<Blog> blogs = blogRepository.findByTitleContainingIgnoreCase(title, userId, pageable);
        ...
        @Transactional(readOnly = true)
        public Page<BlogSummaryDTO> getRecentBlogs(Integer userId, Pageable pageable) {
            Integer currentUserId = jwtUtils.getUserIdFromContext();
            Page<Blog> blogs;

            if (userId != null) {
                blogs = blogRepository.findRecentApprovedBlogs(userId, pageable);
            } else {
                blogs = blogRepository.findRecentApprovedBlogs(null, pageable);
            }
        ...
        @Transactional(readOnly = true)
        public Page<BlogSummaryDTO> getMostViewedBlogs(Integer userId, Pageable pageable) {
            Integer currentUserId = jwtUtils.getUserIdFromContext();
            Page<Blog> blogs = blogRepository.findMostViewedBlogs(userId, pageable);
        ...
        @Transactional(readOnly = true)
        public Page<BlogSummaryDTO> getMostLikedBlogs(Integer userId, Pageable pageable) {
            Integer currentUserId = jwtUtils.getUserIdFromContext();
            Page<Blog> blogs = blogRepository.findMostLikedBlogs(userId, pageable);
