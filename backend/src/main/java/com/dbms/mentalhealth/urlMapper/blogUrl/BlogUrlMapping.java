...
public class BlogUrlMapping {
    ...
    public static final String GET_ALL_BLOGS = BASE_API + "/all"; // Get all blogs
    public static final String GET_BLOGS_BY_USER = BASE_API + "/user"; // Get all blogs by user
    public static final String GET_BLOGS_BY_APPROVAL_STATUS = BASE_API + "/approval-status";
    public static final String INCREMENT_VIEW_COUNT = BASE_API + BLOG_ID_PATH + "/view";
    public static final String INCREMENT_LIKE_COUNT = BASE_API + BLOG_ID_PATH + "/like";
