...
public class TimeSlotUrlMapping {
    ...
    public static final String CREATE_TIME_SLOTS = BASE_API + ADMIN_ID_PATH; // Create time slots for a single date or date range
    public static final String UPDATE_TIME_SLOTS = BASE_API + ADMIN_ID_PATH; // Update time slots for a single date or date range
    public static final String DELETE_TIME_SLOT = BASE_API + TIME_SLOT_ID_PATH; // Delete a specific time slot
