...
public class TimeSlotUrlMapping {
    ...
    public static final String UPDATE_TIME_SLOTS_BY_ID = BASE_API + ADMIN_ID_PATH + TIME_SLOT_ID_PATH; // Update time slots for a single date or date range
    ...
    public static final String DELETE_TIME_SLOT_BY_ID = BASE_API + ADMIN_ID_PATH + TIME_SLOT_ID_PATH; // Delete a specific time slot
}