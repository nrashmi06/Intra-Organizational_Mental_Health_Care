...
export default function Component() {
  return (
    <div className="flex flex-col min-h-screen">
      <Navbar />
      {/* Hero Section */}
      <section className="w-full py-12 md:py-24 lg:py-32" style={{ background: 'linear-gradient(90deg, rgb(179, 245, 220) 0%, rgb(182, 230, 200) 3%, rgb(209, 224, 230) 18%, rgba(202, 206, 156, 0.64) 41%, rgb(210, 235, 214) 95%)' }}>
      ...
      <section className="w-full py-12 md:py-24 lg:py-32 bg-gray-50">
        ...
        <div className="container px-4 md:px-6 mx-auto">
          <div className="flex flex-col items-center justify-center space-y-4 text-center">
            <div className="space-y-2">
            <h2 className="text-3xl m-2 font-bold tracking-tighter md:text-4xl  ">Our Core Values</h2>
              <p className="max-w-[900px] text-gray-700 md:text-xl dark:text-gray-400">The principles that guide everything we do  
              </p>
            </div>
          </div>
      ...
      {/* CTA Section */}
      <section className="w-full py-12 md:py-24 lg:py-32" style={{ background: 'linear-gradient(#518a72 1.1px, transparent 1.1px), linear-gradient(to right, #518a72 1.1px, #ffffff 1.1px)', backgroundSize: '20px 20px' }}>
        <div className="container px-4 md:px-6 mx-auto">
          <div className="flex flex-col items-center justify-center space-y-4 text-center">
            <div className="space-y-2">
              <h2 className="text-3xl m-2 font-bold tracking-tighter md:text-4xl border-2 border-grey-700 rounded-lg bg-green-900 text-white md:text-4xl">Join Our Community</h2>
              <p className="max-w-[600px] text-gray-700 md:text-xl  bg-white dark:text-gray-400"><b>Be part of something meaningful. Start your journey with SerenitySphere today.</b>
