...
import { useAppDispatch } from '@/hooks/useAppDispatch'; // Use the typed dispatch hook
import { getAllHelplines } from '@/service/emergency/GetEmergencyHelpline'; // Adjusted import path
...
export default function Component() {
  ...
  const helplinesFromState = useSelector((state: RootState) => state.emergency.helplines);

  useEffect(() => {
    // Dispatch the getAllHelplines action
